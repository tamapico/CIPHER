...
VOID WINAPI AesCfbEncrypt(BYTE* in, DWORD cbIn, BYTE* IV, BYTE* Key, DWORD cbitSegment, BYTE* out)
{
	DWORD cbSegment, cbRemain, W[60];
	BYTE inTemp[16], MsgTemp[16], outTemp[16], * pInCurrent;
...
//                   v                                 v                                  v
//              Plane Text 1                      Plane Text 2                       Plane Text N
VOID WINAPI AesCfbDecrypt(BYTE* in, DWORD cbIn, BYTE* IV, BYTE* Key, DWORD cbitSegment, BYTE* out)
{
	DWORD cbSegment, cbRemain, W[60];
	BYTE inTemp[16], MsgTemp[16], outTemp[16], * pInCurrent;
...
// AES による暗号化と複合化のテスト
VOID WINAPI CipherAndInvCipher(BYTE* in, DWORD cbIn, BYTE* IVorICV, BYTE* Key, DWORD cbitSegment, DWORD dwMode)
{
	DWORD i;
	BYTE* cipher, * out;
...
INT main(INT argc, CHAR* argv[])
{
	...
	DWORD AesExample1_SegmentLength = 128;
	...
	CipherAndInvCipher(AesExample1_Input, AesExample1_CbInput, NULL, AesExample1_Key, 0, AES_MODE_ECB);
	printf("\r\n");
	CipherAndInvCipher(AesExample1_Input, AesExample1_CbInput, AesExample1_IV, AesExample1_Key, 0, AES_MODE_CBC);
	printf("\r\n");
	CipherAndInvCipher(AesExample1_Input, AesExample1_CbInput, AesExample1_IV, AesExample1_Key, AesExample1_SegmentLength, AES_MODE_CFB);
	printf("\r\n");
	CipherAndInvCipher(AesExample1_Input, AesExample1_CbInput, AesExample1_IV, AesExample1_Key, 0, AES_MODE_OFB);
	printf("\r\n");
	CipherAndInvCipher(AesExample1_Input, AesExample1_CbInput, AesExample1_ICV, AesExample1_Key, 0, AES_MODE_CTR);
	printf("\r\n");
	...
	DWORD AesExample2_SegmentLength = 128;
	...
	CipherAndInvCipher(AesExample2_Input, AesExample2_CbInput, NULL, AesExample2_Key, 0, AES_MODE_ECB);
	printf("\r\n");
	CipherAndInvCipher(AesExample2_Input, AesExample2_CbInput, AesExample2_IV, AesExample2_Key, 0, AES_MODE_CBC);
	printf("\r\n");
	CipherAndInvCipher(AesExample2_Input, AesExample2_CbInput, AesExample2_IV, AesExample2_Key, AesExample2_SegmentLength, AES_MODE_CFB);
	printf("\r\n");
	CipherAndInvCipher(AesExample2_Input, AesExample2_CbInput, AesExample2_IV, AesExample2_Key, 0, AES_MODE_OFB);
	printf("\r\n");
	CipherAndInvCipher(AesExample2_Input, AesExample2_CbInput, AesExample2_ICV, AesExample2_Key, 0, AES_MODE_CTR);
	printf("\r\n");
	...
	DWORD AesExample3_SegmentLength = 128;
	...
	CipherAndInvCipher(AesExample3_Input, AesExample3_CbInput, NULL, AesExample3_Key, 0, AES_MODE_ECB);
	printf("\r\n");
	CipherAndInvCipher(AesExample3_Input, AesExample3_CbInput, AesExample3_IV, AesExample3_Key, 0, AES_MODE_CBC);
	printf("\r\n");
	CipherAndInvCipher(AesExample3_Input, AesExample3_CbInput, AesExample3_IV, AesExample3_Key, AesExample3_SegmentLength, AES_MODE_CFB);
	printf("\r\n");
	CipherAndInvCipher(AesExample3_Input, AesExample3_CbInput, AesExample3_IV, AesExample3_Key, 0, AES_MODE_OFB);
	printf("\r\n");
	CipherAndInvCipher(AesExample3_Input, AesExample3_CbInput, AesExample3_ICV, AesExample3_Key, 0, AES_MODE_CTR);
	printf("\r\n");
	...
	DWORD AesExample4_SegmentLength = 8;
	...
	BYTE AesExample4_Input[64] = { 0x6B, 0xC1, 0xBE, 0xE2, 0x2E, 0x40, 0x9F, 0x96, 0xE9, 0x3D, 0x7E, 0x11, 0x73, 0x93, 0x17, 0x2A };
	DWORD AesExample4_CbInput = 16;

	CurrentAESBitLength = AES128;
	CipherAndInvCipher(AesExample4_Input, AesExample4_CbInput, AesExample4_IV, AesExample4_Key1, AesExample4_SegmentLength, AES_MODE_CFB);
	printf("\r\n");

	CurrentAESBitLength = AES192;
	CipherAndInvCipher(AesExample4_Input, AesExample4_CbInput, AesExample4_IV, AesExample4_Key2, AesExample4_SegmentLength, AES_MODE_CFB);
	printf("\r\n");

	CurrentAESBitLength = AES256;
	CipherAndInvCipher(AesExample4_Input, AesExample4_CbInput, AesExample4_IV, AesExample4_Key3, AesExample4_SegmentLength, AES_MODE_CFB);
	printf("\r\n");
